...
#include <vector>
enum OBJECT_TYPE { OBJ_BASE, OBJ_PLAYER, OBJ_BULLET, OBJ_ENEMY, OBJ_TURRET, OBJ_PICKUP, OBJ_BUILDING, OBJ_MINE, OBJ_TANK, OBJ_TREE, OBJ_FLYTEXT, OBJ_NAZIBOSS, OBJ_HELP, OBJ_FACTORY, OBJ_JET, OBJ_PIRATEBOSS, OBJ_EMPBLAST, OBJ_ROBOTBOSS };
enum BULLETYPE { BUL_SHELL, BUL_ROCKET, BUL_ARTILLERY, BUL_MACHINEGUN, BUL_LASER, BUL_FLAME };
enum BOSSTYPE {NAZI, PIRATE, ALIEN, ROBOT};
