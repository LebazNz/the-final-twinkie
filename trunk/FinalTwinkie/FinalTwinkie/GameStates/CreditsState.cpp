...
void CCreditsState::Render(void)
{
	...
	font->Print("Executive Producer:",(CGame::GetInstance()->GetWidth()/2)-75,(CGame::GetInstance()->GetHeight()/2)+75,0.75f,			D3DCOLOR_XRGB(255,0,0));
	font->Print("John O'Leske",(CGame::GetInstance()->GetWidth()/2)-75,(CGame::GetInstance()->GetHeight()/2)+105,0.75f,					D3DCOLOR_XRGB(255,0,0));
	font->Print("Associate Producer:",(CGame::GetInstance()->GetWidth()/2)-75,(CGame::GetInstance()->GetHeight()/2)+150,0.75f,			D3DCOLOR_XRGB(255,0,0));
	font->Print("Shawn Paris",(CGame::GetInstance()->GetWidth()/2)-75,(CGame::GetInstance()->GetHeight()/2)+180,0.75f,					D3DCOLOR_XRGB(255,0,0));
	font->Print("Art Lead:",(CGame::GetInstance()->GetWidth()/2)-75,(CGame::GetInstance()->GetHeight()/2)+205,0.75f,					D3DCOLOR_XRGB(255,0,0));
