...
#include <vector>
enum OBJECT_TYPE { OBJ_BASE, OBJ_PLAYER, OBJ_BULLET, OBJ_ENEMY, OBJ_TURRET, OBJ_PICKUP, OBJ_BUILDING, OBJ_MINE, OBJ_TANK, OBJ_TREE, OBJ_FLYTEXT, OBJ_NAZIBOSS, OBJ_HELP, OBJ_FACTORY, OBJ_JET, OBJ_PIRATEBOSS };
