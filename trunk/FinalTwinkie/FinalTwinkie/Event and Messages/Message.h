...
enum MessageType { MSG_CREATEBULLET, MSG_DESTROYBULLET, MSG_CREATEENEMY, MSG_DESTROYENEMY, MSG_DESTROYTURRET, MSG_CREATEPICKUP, MSG_DESTROYPICKUP,
	...
	MSG_CREATEFLYTEXT,MSG_DESTROYFLYTEXT, MSG_CREATEJET, MSG_DESTROYJET, MSG_BOSSFIRE, MSG_DESTROYNAZIBOSS, MSG_CREATEBOSS, MSG_CREATEFACTORY, 
	MSG_DESTROYFACTORY, MSG_DESTROYPIRATEBOSS, MSG_CREATEEMP, MSG_DESTROYEMP, MSG_DESTROYROBOTBOSS};
